...
public class Config {
	...
	CommandLineRunner htmlCommandLineRunner(HtmlRepository repository) {
		return args -> {
			...
			content.add(formulas.getTabInSpaces() + "Line 12<br>");
			content.add(formulas.getTabInSpaces() + "<br>");
			content.add(formulas.getTabInSpaces() + "<a href=\"TITLE 2.html\">TITLE 2</a><br>");
			content.add("</body>");
			content.add("</html>");
			...
			content.add(formulas.getTabInSpaces() + "Line 22<br>");
			content.add(formulas.getTabInSpaces() + "<br>");
			content.add(formulas.getTabInSpaces() + "<a href=\"TITLE 3.html\">TITLE 3</a><br>");
			content.add("</body>");
			content.add("</html>");
			...
			content.add(formulas.getTabInSpaces() + "Line 22<br>");
			content.add(formulas.getTabInSpaces() + "<br>");
			content.add(formulas.getTabInSpaces() + "<a href=\"TITLE 1.html\">TITLE 1</a><br>");
			content.add("</body>");
			content.add("</html>");
