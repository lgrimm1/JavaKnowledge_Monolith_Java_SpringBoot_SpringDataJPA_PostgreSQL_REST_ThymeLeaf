...
public class Config {
	...
	CommandLineRunner txtCommandLineRunner(TxtRepository repository) {
		List<String> content1 = List.of(
				...
				"",
				"File:",
				"	- a Browse button appears, next to it the chosen file name or number of files",
				...
				"	- more forms and fieldsets can be used on a page at the same time if needed",
				"	- usually used together with <label> tag which produces the shown text (consider id= and for= parameters)",
				"",
				"Range:",
				"	- a slider appears",
				...
				"	- the size= parameter defines the number of visible items, and the select will work as a list control, otherwise will work as a combobo",
				"	- the multiple parameter lets more items to be selected in list control appearance",
				"	- <option> sub-tags define from which items can be the input value chosen",
				"	- an <option> tag contains the value= parameter which will be posted",
				"	- the selected parameter selects an item",
				...
				"	- between the opening and closing markers of an <option> tag the displayed text is written",
				"",
				"Submit:",
				"	- a button appears",
				...
				"	- the name= parameter defines name of the control",
				...
				"	- between the opening and closing markers of the tag the starting text can be written",
				...
				"	- the form= parameter marks which form the input is part of, it has effect only when in the header of the form the id= parameter is used, such marked inputs can be placed outside the correspondent <form> tag but they still will be part of the correspondent form",
