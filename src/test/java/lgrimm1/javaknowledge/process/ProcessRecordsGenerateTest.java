...
class ProcessRecordsGenerateTest {
	...
	void generate() {
		...
		HtmlEntity givenHtmlEntity2 = new HtmlEntity(htmlContentList2, new ArrayList<>());
		HtmlEntity savedHtmlEntity2 = new HtmlEntity(444L, htmlContentList2, new ArrayList<>());
		HtmlEntity originalHtmlEntity3 = new HtmlEntity(
				333L,
